...
export function RewardModal({
  ...
  useEffect(() => {
    ...
    // Listen for points updates from other components (like Chatbot)
    const handlePointsUpdate = () => {
      // Reload local data first for immediate UI update
      const localData = localStorage.getItem('auraasync_user_data');
      if (localData) {
        const parsed = JSON.parse(localData);
        if (parsed.points !== undefined) {
          setUserCoins(parsed.points);
        }
      }
    };

    window.addEventListener('user_points_updated', handlePointsUpdate);
    return () => {
      window.removeEventListener('user_points_updated', handlePointsUpdate);
    };
  ...
  const modalContent = (
    ...
    >
      <div
        className="w-full max-w-6xl max-h-[70vh]  rounded-2xl overflow-hidden shadow-2xl relative flex flex-col"
      ...
      >
        ...
        <div className="bg-gradient-to-r from-amber-500/20 to-orange-500/20 px-4 py-3 md:px-8 md:py-6 border-b border-white/10 flex-shrink-0">
          ...
          <p className="text-gray-300 text-xs md:text-sm mt-1">
            Earn coins by completing tasks and unlock premium features
          </p>
        </div>

        {/* Main Content - Scrollable */}
        <div className="overflow-y-auto   flex-1 px-4 py-4 md:p-8">
          <div className="grid grid-cols-1 relative  lg:grid-cols-2 gap-6 md:gap-8">
            {/* Left Side - Tasks List */}
            <div className="space-y-6 md:border-r-2 md:pr-8 border-white/40 lg:sticky lg:top-6 lg:self-start lg:max-h-[calc(70vh-4rem)] lg:overflow-y-auto">
              ...
              <div className="bg-gradient-to-br from-amber-500/30 to-orange-500/20 rounded-xl p-4 md:p-6 border border-amber-500/30">
                ...
                <div className="text-2xl md:text-4xl font-bold text-white mb-3 md:mb-4">
                  {userCoins}
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <div className="w-full bg-white/10 rounded-full h-2 overflow-hidden">
                    <div
                      ...
                      style={{
                        width: `${Math.min((userCoins / 100) * 100, 100)}%`,
                      }}
                    />
                  </div>
                </div>
                          ...
                          {!task.completed && !task.claimed && (
                            <button
                              ...
                              onClick={(e) => {
                                ...
                                e.stopPropagation();
                                console.log(
                                  "Complete Task button clicked for:",
                                  task.id
                                );
                                handleIncompleteTask(task);
                              }}
            ...
            <div className="space-y-10 overflow-y-auto">
              {/* --- AI Outfit Pairing Card --- */}
              <div className="space-y-6">
                {/* Image Card */}
                <div className="relative rounded-xl overflow-hidden h-48 md:h-64 group">
                  <div className="absolute inset-0 transition-transform duration-700 group-hover:scale-105">
                    <Image
                      fill
                      src="/rewardmodal.png"
                      alt="AI Outfit Pairing"
                      className="object-cover"
                    />
                  </div>

                  <div className="absolute inset-0 bg-gradient-to-t from-black/50 to-transparent group-hover:opacity-90 transition-opacity" />

                  <div className="absolute bottom-0 z-10 p-4 transition-transform duration-500 group-hover:-translate-y-2">
                    <h1 className="text-lg md:text-xl font-bold">
                      AI Outfit Pairing & 10-Day Style Calendar
                    </h1>
                    <p className="text-xs md:text-sm mt-1">
                      Upload your wardrobe and let our AI stylist create smart
                      outfit combinations for you! Get personalized pairing
                      suggestions and unlock a 10-day style calendar.
                    </p>
                  </div>
                </div>
                ...
                <div className="space-y-4">
                  ...
                  <p className="text-gray-300 text-sm leading-relaxed">
                    Upload your clothes and get AI-generated outfit suggestions
                    tailored to your wardrobe.
                  </p>

                  {/* Pricing */}
                  <div className="pt-4 border-t border-white/10">
                    <div className="flex items-start gap-3 p-3 bg-white/10 rounded-lg border border-white/20">
                      ...
                      <div>
                        ...
                        <p className="text-gray-300 text-xs">
                          500 coins = 10-day outfit calendar
                        </p>
                      </div>
                    </div>
                  </div>
              ...
              <div className="space-y-6">
                ...
                <div className="relative rounded-xl overflow-hidden h-48 md:h-64 group">
                  ...
                  <div className="absolute bottom-0 z-10 p-4 transition-transform duration-500 group-hover:-translate-y-2">
                    ...
                    <p className="text-xs md:text-sm mt-1">
                      See how clothes look on you before buying! Upload your
                      photo and virtually try on any outfit with realistic AI
                      visualization.
                    </p>
                  </div>
                </div>
                ...
                <div className="space-y-4">
                  ...
                  <p className="text-gray-300 text-sm leading-relaxed">
                    ...
                    virtual try-on. Upload your photo and instantly preview
                    outfits with high realism.
                  </p>
                  ...
                  <div className="pt-4 border-t border-white/10">
                    <div className="flex items-start gap-3 p-3 bg-white/10 rounded-lg border border-white/20">
                      ...
                      <div>
                        ...
                        <p className="text-gray-300 text-xs">
                          100 coins per virtual try-on session
                        </p>
                      </div>
                    </div>
                  </div>
