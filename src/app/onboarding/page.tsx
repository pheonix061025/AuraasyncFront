        ...
        >
          ...
          <div className="relative z-10 min-h-screen flex items-center justify-center p-6">
            ...
            >
              ...
              <p className="text-base mb-8 text-gray-200 text-center">
                Let&apos;s personalize your fashion journey
              </p>
              ...
              <button
                onClick={handleGoogleLogin}
                disabled={isLoading}
                className="w-full bg-white text-gray-900 px-8 py-4 rounded-xl font-semibold text-lg hover:bg-gray-100 transition-all flex items-center justify-center gap-3 disabled:opacity-50 disabled:cursor-not-allowed shadow-lg hover:shadow-xl"
              >
                {isLoading ? (
